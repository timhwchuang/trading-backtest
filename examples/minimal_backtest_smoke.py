...
def main() -> None:
    ...
    # Demo with synthetic ticks (in real use you would have real cache files)
    demo_ticks = [
    ...
    print("trading-backtest version:", __version__)
    print("clock advanced to:", engine.clock())
    print("host is TradingEngine:", type(engine.host).__name__)
    print("run completed successfully (deterministic replay with same kernel as live).")
